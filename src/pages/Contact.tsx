...
const Contact = () => {
  ...
  return (
    <>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center px-8 py-4 bg-blue-900 dark:bg-blue-700 text-white font-semibold rounded-lg hover:bg-blue-800 dark:hover:bg-blue-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                  >
                    Send Request
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <a
                      key={index}
                      href={info.link || '#'}
                      className="flex items-start space-x-4 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                    >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                ...
                <div className="bg-transparent h-64 rounded-lg flex items-center justify-center">
                  <div className="text-center text-gray-500 dark:text-gray-400">
                    <img src="/flawlessauto.png" className="object-cover border border-gray-300 dark:border-gray-600 mx-auto mb-2" />
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Emergency Contact */}
      <section className="py-16 bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 text-white">
